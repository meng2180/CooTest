...
def rq_inference(model_path, dataset_path, operator, is_use_formula=False):
    """
    ...
    if fusion_method == 'nofusion':
        ...
        for i, batch_data in enumerate(data_loader):
            ...
            det_save_path = "/mnt/e/Workspace/LabProject/CooTestFin/_dataset/test/rq2/rq2_det_box"
